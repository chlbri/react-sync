...
- Migrate build tooling from `rollup`/`tsup` to `rolldown`
- Add `oxfmt` and `oxlint` for formatting and linting
- Reorganize tests directory from `tests/` to `__tests__/`
- Add GitHub Actions workflows: CI, publish-beta, publish-canary, upgrade
